...
public:
    ...
    {
        return *reinterpret_cast<bool*>(std::uintptr_t(this) + 0x3C);
    }
};
...
public:
    ...
    {
        return *reinterpret_cast<ClientSharedObjectCache<EconItem>**>(std::uintptr_t(this) + 0xB4);
    }
    ...
    {
        return *reinterpret_cast<SOID*>(std::uintptr_t(this) + 0x8, 0x10);
    }
};
