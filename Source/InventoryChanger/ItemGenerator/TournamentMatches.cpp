...
namespace inventory_changer::item_generator
{
    ...
    [[nodiscard]] static std::variant<std::span<const MatchWithMVPs>, std::span<const Match>> getTournamentMatches(Tournament tournament) noexcept
    {
    ...
    std::variant<std::span<const MatchWithMVPs>, std::span<const Match>> getTournamentMatchesOnMap(Tournament tournament, TournamentMap map) noexcept
    {
