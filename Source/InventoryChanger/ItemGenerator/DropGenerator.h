...
namespace inventory_changer::item_generator
{
    ...
    private:
        ...
        [[nodiscard]] inventory::SkinStickers generateSouvenirStickers(WeaponId weaponID, Tournament tournament, TournamentMap map, TournamentTeam team1, TournamentTeam team2, ProPlayer player) const
        {
            inventory::SkinStickers stickers;

            stickers[0].stickerID = gameItemLookup.findTournamentEventStickerID(tournament);

            if (tournament >= Tournament::EmsOneKatowice2014) {
                ...
                else if (tournament >= Tournament::PglStockholm2021)
