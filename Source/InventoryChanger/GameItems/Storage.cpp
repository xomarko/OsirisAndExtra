...
namespace inventory_changer::game_items
{
    ...
    void Storage::addSticker(int id, ItemName name, EconRarity rarity, std::string_view iconPath, Tournament tournament, TournamentTeam tournamentTeam, int tournamentPlayerID, bool isGoldenSticker)
    {
    ...
    void Storage::addTournamentCoin(EconRarity rarity, WeaponId weaponID, Tournament tournament, std::uint16_t defaultGraffitiID, std::string_view iconPath)
    {
    ...
    void Storage::addCrate(EconRarity rarity, WeaponId weaponID, std::uint16_t crateSeries, Tournament tournament, TournamentMap map, bool isSouvenirPackage, std::string_view iconPath)
    {
    ...
    void Storage::addSouvenirToken(EconRarity rarity, WeaponId weaponID, Tournament tournament, std::string_view iconPath)
    {
        addItem(Item::Type::SouvenirToken, rarity, weaponID, static_cast<std::size_t>(tournament), pooled(iconPath));
    }

    void Storage::addViewerPass(EconRarity rarity, WeaponId weaponID, Tournament tournament, std::string_view iconPath)
    {
